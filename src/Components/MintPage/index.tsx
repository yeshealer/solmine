...
export default function MintPage() {
    ...
    return (
        <MintBody>
            ...
            <MintContent>
                <img src='assets/mint-section-art.png' className='mint-main-art w-[250px] md:w-[360px] lg:w-[450px] 2xl:w-auto' alt='mint page main art' />
                ...
                <MintCard>
                    ...
                    <CardBody>
                        <CardSection>
                            ...
                            <TextGroup className='mt-1 lg:mt-3 xl:mt-5'>
                            ...
                            <ImageBtn className='mt-5 sm:mt-1 lg:mt-3 xl:mt-8'>Mint</ImageBtn>
                        </CardSection>
                        <img src='assets/mint-card-image.png' alt='MintCard' className='w-[180px] md:w-[220px] lg:w-[250px] xl:w-auto' draggable={false} />
                    </CardBody>
                </MintCard>
