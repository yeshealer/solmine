...
export const Title = wrapn('div')`
    mint-title 
    text-[28px] sm:text-[32px] md:text-[50px] lg:text-[70px] 2xl:text-[90px]
...
export const CardBody = wrapn('div')`
    mint-card-body 
    w-full sm:w-[635px] md:w-[750px] lg:w-[920px] xl:w-[1150px]
    h-auto sm:h-[275px] md:h-[325px] lg:h-[400px] xl:h-[500px] 
    -mt-1 
    pr-0 sm:p-[30px] md:p-[40px] xl:p-[50px] xl:pt-[62px] xl:pr-[73px] xl:pb-[71px] xl:pl-[136px] 
...
export const CardText = wrapn('div')`
    font-["Nippo"] text-base lg:text-lg font-bold text-[#00F1D6]
`
...
export const PlusMinusGroup = wrapn('div')`
    ...
    text-lg lg:text-xl 
    font-["Nippo"]
    mt-1 lg:mt-3 xl:mt-5
    py-5 sm:py-0
`

export const Description = wrapn('div')`
    mt-6 lg:mt-12 
    max-w-2xl md:max-w-3xl lg:max-w-4xl xl:max-w-6xl 
